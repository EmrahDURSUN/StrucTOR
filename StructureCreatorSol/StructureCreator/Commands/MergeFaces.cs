...
{
    class MergeFacesCapsule : CommandCapsule
    {
        public const string CommandName = "ConstructorAddIn.C#.V19.MergeFaces";

        public MergeFacesCapsule()
            : base(CommandName, Resources.MergeFacesText, Resources.MergetImage, Resources.MergeFacesHint)
        {
        }
