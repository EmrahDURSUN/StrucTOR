...
namespace StructureCreator
{
    ...
    /// </summary>
    class ReadForcePointCapsule : CommandCapsule
    {
        public const string CommandName = "ConstructorAddIn.C#.V19.ReadForcePoint";

        public ReadForcePointCapsule()
            : base(CommandName, Resources.ReadForcePointText, null, Resources.ReadForcePointHint)
        {
        }
