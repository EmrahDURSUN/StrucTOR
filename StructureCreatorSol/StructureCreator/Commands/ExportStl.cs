...
{
    class ExportStlCapsule : CommandCapsule
    {
        public const string CommandName = "ConstructorAddIn.C#.V19.ExportStl";

        public ExportStlCapsule()
            : base(CommandName, Resources.ExportStlText, Resources.ExportImage, Resources.ExportStlHint)
        {
        }
        ...
        protected override void OnExecute(Command command, ExecutionContext context, Rectangle buttonRect)
        {
            ...
            System.Windows.Forms.Application.Run(new ExportStlForm());
